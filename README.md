# [Odayaka](https://odayaka.vn) Source Code

This is the source code of Odayaka Phu Quoc Island, a Motorbike rent booking, hotel booking, account selling built 
with [Jekyll](http://jekyllrb.com), [Gulp](http://gulpjs.com/), and 
[Travis CI](https://travis-ci.org/).

*Please note: Odayaka Cho thue xe Phu Quoc hasn't been "themed" like some of my other 
[Jekyll repos](https://odayaka.vn/work/jekyll-themes/) and isn't compatible 
...
[Odayaka Rent Motorbike at Phu Quoc Island](https://odayaka.vn) has a lot of image assets. 
`src/assets/images/` has been split into its **own repo** and included as a Git submodule.
...
Call-out text. Accepts the following types: `info`, `danger`, `warning`, and `success`. See [style guide](https://odayaka.vn/style-guide/) for visual examples.
